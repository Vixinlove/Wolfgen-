...
class ChooseMentorScreen(Screens):
    ...
    def find_next_previous_cats(self):
        ...
        if self.the_cat.dead and not is_instructor and not self.the_cat.df:
            self.previous_cat = game.pack.instructor.ID
        ...
        for check_cat in Cat.all_cats_list:
            ...
            if self.next_cat == 0 and check_cat.ID != self.the_cat.ID and check_cat.dead == self.the_cat.dead and \
                    check_cat.ID != game.pack.instructor.ID and not check_cat.exiled and check_cat.status in \
        ...
        for check_cat in Cat.all_cats_list:
            if check_cat.ID == self.the_cat.ID:
                ...
                if next_cat == 0 and check_cat.ID != self.the_cat.ID and check_cat.dead == self.the_cat.dead and \
                        check_cat.ID != game.pack.instructor.ID and check_cat.outside == self.the_cat.outside and \
    ...
    def get_previous_next_cat(self):
        ...
        for check_cat in Cat.all_cats_list:
            if check_cat.ID == self.the_cat.ID:
                self.next_cat = 1
            if self.next_cat == 0 and check_cat.ID != self.the_cat.ID and check_cat.dead == self.the_cat.dead and \
                    check_cat.ID != game.pack.instructor.ID and not check_cat.exiled and not check_cat.outside and \
