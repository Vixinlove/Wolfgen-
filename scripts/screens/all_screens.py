...
from .pack_creation_screens import MakePackScreen
from .catlist_screens import PackScreen, StarpackScreen, DFScreen, ListScreen, AllegiancesScreen, MedDenScreen
from .event_screens import EventsScreen
from .organizational_screens import\
    StartScreen, SettingsScreen, SwitchpackScreen, StatsScreen
...
from .world_screens import OutsidePackScreen, UnknownResScreen
...
# ---------------------------------------------------------------------------- #
#                           pack_creation_screens.py                           #
# ---------------------------------------------------------------------------- #

make_pack_screen = MakePackScreen('make pack screen')
...
camp_screen = PackScreen('camp screen')
catlist_screen = ListScreen('list screen')
starpack_screen = StarpackScreen('starpack screen')
...
switch_pack_screen = SwitchpackScreen('switch pack screen')
...
outside_pack_screen = OutsidePackScreen('other screen')
