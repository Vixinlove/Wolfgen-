...
class Screens():
        ...
        "name_background": pygame_gui.elements.UIImage(
            ...
            pygame.transform.scale(
                image_cache.load_image(
                    "resources/images/pack_name_bg.png").convert_alpha(),
                (380, 70)),
            visible=False,
            manager=MANAGER),
    ...
    def change_screen(self, new_screen):
        ...
        if self.name in ['camp screen', 'list screen', 'starpack screen', 'dark forest screen', 'events screen',
                         'med den screen']:
    ...
    def mns_close(self):
        ...
        self.moons_n_seasons_moon = UIImageButton(
            ...
            container = self.menu_buttons['moons_n_seasons'],
            starting_height=2,
            tool_tip_text= f'{game.pack.age} {moons_text}')
        ...
        self.moons_n_seasons_season = UIImageButton(
            ...
            container = self.menu_buttons['moons_n_seasons'],
            starting_height=2,
            tool_tip_text= f'{game.pack.current_season}')
