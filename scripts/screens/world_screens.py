...
class OutsidePackScreen(Screens):
    ...
    def handle_event(self, event):
        if event.type == pygame_gui.UI_BUTTON_START_PRESS:
            if event.ui_element == self.your_pack_button:
    ...
    def screen_switches(self):
        ...
        self.your_pack_button = UIImageButton(scale(pygame.Rect((230, 270), (68, 68))), "", object_id="#your_pack_button")
        self.outside_pack_button = UIImageButton(scale(pygame.Rect((298, 270), (68, 68))), "",
                                                 object_id="#outside_pack_button", manager=MANAGER)
        self.outside_pack_button.disable()
...
class UnknownResScreen(Screens):
    ...
    def handle_event(self, event):
        if event.type == pygame_gui.UI_BUTTON_START_PRESS:
            ...
            elif event.ui_element == self.starpack_button:
                self.change_screen('starpack screen')
    ...
    def get_dead_cats(self):
        self.dead_cats = []
        for the_cat in Cat.all_cats_list:
            if the_cat.ID in game.pack.unknown_cats and not the_cat.faded:
