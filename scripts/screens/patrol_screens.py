...
class PatrolScreen(Screens):
    ...
    def handle_patrol_complete_events(self, event):
        ...
        elif event.ui_element == self.elements["pack_return"]:
    ...
    def open_patrol_complete_screen(self, user_input):
        ...
        self.elements["pack_return"] = UIImageButton(scale(pygame.Rect((800, 274), (324, 60))), "",
                                                     object_id="#return_to_pack", manager=MANAGER)
