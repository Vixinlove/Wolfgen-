...
class Relation_Events():
    ...
    def outsider_events(self, cat):
        """
            ...
            This function will handle when the cat interacts with cat which are outside of the pack.
        """
        print("TODO")

    def welcome_new_cats(self, new_cats = None):
        """This function will handle the welcome of new cats, if there are new cats in the pack."""
