...
class OutsiderEvents:
    ...
    def killing_outsiders(self, cat: Cat):
        ...
        if cat.outside:
            if random.getrandbits(6) == 1 and not cat.dead:
                ...
                elif cat.status in ['kittypet', 'loner', 'rogue', 'former Packwolf']:
    ...
    def lost_cat_become_outsider(self, cat: Cat):
        ...
        TODO: need to make a unique backstory for these cats so they still have thoughts related to their pack
        """
