...
class Group_Events():
    ...
    def start_interaction(self, cat: Cat, interact_cats: list) -> list:
        ...
        biome = str(game.pack.biome).casefold()
        season = str(game.pack.current_season).casefold()
    ...
    def cat_allow_interaction(self, interaction: Group_Interaction):
        ...
        if game.pack.game_mode == 'classic' and len(interaction.has_injuries) > 0:
            return False
