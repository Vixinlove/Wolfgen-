...
from scripts.utility import event_text_adjust, change_pack_relations, change_relationship_values
...
class MiscEvents():
    ...
    def handle_misc_events(self, cat, other_cat=None, war=False, enemy_pack=None, alive_kits=False, accessory=False, ceremony=False):
        """ 
        ...
        final_events = self.generate_events.filter_possible_short_events(acc_checked_events, cat, other_cat, war, enemy_pack, other_pack,
        ...
        event_text = event_text_adjust(Cat, misc_event.event_text, cat, other_cat, other_pack_name, murder_reveal=reveal, victim=victim)

        types = ["misc"]
        if "other_pack" in misc_event.tags:
