from scripts.utility import get_alive_pack_queens
...
class Freshkill_Pile():
    """Handle everything related to the freshkill pile of the pack."""
    ...
    def feed_cats(self, living_cats: list) -> None:
        ...
        relevant_group = []
        queens = get_alive_pack_queens(Cat)
        relevant_queens = []
        for queen in queens:
    ...
    def pack_has_enough_food(self) -> bool:
        """
            Returns
            -------
            _ : bool
