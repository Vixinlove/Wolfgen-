; Wolf-gen Installer Script

#define ApplicationBaseName "Wolf-gen"
#define ApplicationFullName "Wolf-gen (fan edit) by Sablesteel"

; Update this line to the date of the latest Wolf-gen (fan edit) by Sablesteel release 
; (or choose your own version-numbering scheme)
#define ApplicationVersion "2022.08.10"

#define ApplicationURL "https://sablesteel.itch.io/pack-gen-fan-edit"

; Comment out the following line and uncomment the second one in order to place help files, EULA, etc.
; in the same program group as the main Wolf-gen' shortcuts
...
; Flags: onlyifdoesntexist prevents settings and packlist.txt from being overwritten after update
...
;-------------------------------------------------------------------------------
[Icons]
;; Create Wolf-gen (fan edit) icons
Name: {group}\Wolf-gen (fan edit); Filename: {app}\main.exe; Comment: "Wolf-gen (fan edit) by Sablesteel"
Name: {commondesktop}\Wolf-gen (fan edit); Filename: {app}\main.exe; Comment: "Wolf-gen (fan edit) by Sablesteel";
